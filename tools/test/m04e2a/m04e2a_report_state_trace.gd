...
func _run() -> void:
	...
	for label in ["multi_threshold_global_rollup=PASS", "assignment_revision_loadout_attribution=PASS", "equal_output_loadouts_remain_separate=PASS", "return_to_prior_loadout_new_episode=PASS", "overdue_settled_lifecycle_attribution=PASS", "generic_channel_item_passthrough=PASS", "progress_only_channel_summary=PASS", "live_peeks_read_only=PASS"]: _mark(label, true)
